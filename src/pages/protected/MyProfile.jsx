...
const MyProfile = () => {
  ...
  return (
    <>
      <Col style={{padding:"10px", maxWidth:"70%", margin:"auto"}} xl="18">
        <Card body>
          <div>
            <h6 style={{ textAlign: "center" }}>My Profile</h6>
            <Col xl="15">
            ...
            <Col style={{padding:"10px", maxWidth:"90%", margin:"auto"}} xl="18">
            <Row>
              <h6 style={{ textAlign: "center" }}>Basic Info</h6>
